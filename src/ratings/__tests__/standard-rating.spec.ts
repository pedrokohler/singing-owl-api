...
describe('Standard scoring strategy', () => {
  ...
  describe('Given an array of ratings about different items', () => {
    it('should return null if the array is empty', () => {
      const result = ratingsService.computeAggregateRatings([]);
      expect(result).toBeNull();
    });

    it('should compute the aggregate ratings of each item reviewed', () => {
      const itemReviewed = 'item-id';
      const secondItemReviewed = 'other-item';
      const author = 'author-id';

      const aggregateRatings = ratingsService.computeAggregateRatings([
    ...
    it('should order the aggregate ratings of each item reviewed', () => {
      const itemReviewed = 'item-id';
      const secondItemReviewed = 'other-item';
      const thirdItemReviewed = 'yet-another-item';
      const fourthItemReviewed = 'yet-again-another-item';
      const author = 'author-id';
